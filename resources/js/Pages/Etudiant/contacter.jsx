        ...
        <div className="bg-white">
            <header className="absolute inset-x-0 top-0 z-50">
                <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                    ...
                    <a href="#" className="text-sm/6 font-semibold text-gray-900 transition ease-in-out hover:scale-105 duration-200">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 grid max-w-lg grid-cols-3 items-center gap-x-8 gap-y-10 sm:max-w-xl lg:max-w-none ">
                    <a href="https://www.linkedin.com/school/ensa-tetouan/">
                    <img
                        alt="Transistor"
                    ...
                    <a href="https://www.facebook.com/ensa.tetouan.officiel">
                    <img
                        alt="Transistor"
                    ...
                    <a href="https://www.instagram.com/ensa_tetouan_officiel/">
                    <img
                        alt="Transistor"
