      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mt-6 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base/7 font-semibold text-gray-900 sm:grid-cols-2 md:flex lg:gap-x-5 mt-6">
                ...
                <a    href={route('Refuser_demande_document', { id: convention.demande_id })} className="rounded-md  bg-rose-600 bg-opacity-90 px-3.5 py-2.5 text-sm text-white shadow-sm hover:bg-rose-500 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
                  Refuser la demandes
                </a>
            </div>
          </div>
