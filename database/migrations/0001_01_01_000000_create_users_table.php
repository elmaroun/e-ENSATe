...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('demandes', function (Blueprint $table) {
            ...
            $table->enum('type_demande', ['Convention de Stage', 'Attestation de Scolarité', 'Attestation de Réussite','Relevé des Notes']);
        ...
        Schema::create('reclamations', function (Blueprint $table) {
            $table->id();
            $table->foreignId('student_id')->constrained('students')->onDelete('cascade')->onUpdate('cascade');
            $table->enum('type',['Problème Technique','Problème de Service à l´école','Autre Problème']);
            $table->text('contenu');
            $table->string('sujet');
            $table->enum('status',['Traitée','En cours','Non traitée'])->default('Non traitée');
            $table->timestamps();
